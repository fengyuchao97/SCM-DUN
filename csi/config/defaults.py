...
_C.MODEL.DENOISER.TYPE = "SCMAMBA"

_C.MODEL.DENOISER.SCMAMBA = CN()
_C.MODEL.DENOISER.SCMAMBA.LOCAL = True
_C.MODEL.DENOISER.SCMAMBA.NON_LOCAL = True
_C.MODEL.DENOISER.SCMAMBA.IN_DIM = 28
_C.MODEL.DENOISER.SCMAMBA.OUT_DIM = 28
_C.MODEL.DENOISER.SCMAMBA.DIM = 28
_C.MODEL.DENOISER.SCMAMBA.WINDOW_SIZE = [8, 8]
_C.MODEL.DENOISER.SCMAMBA.WINDOW_NUM = [8, 8]
_C.MODEL.DENOISER.SCMAMBA.NUM_BLOCKS = [1, 1, 1, 1, 1]
_C.MODEL.DENOISER.SCMAMBA.FFN_NAME = "Gated_Dconv_FeedForward"
_C.MODEL.DENOISER.SCMAMBA.FFN_EXPAND = 2.66
_C.MODEL.DENOISER.SCMAMBA.LAYERNORM_TYPE = "WithBias"
_C.MODEL.DENOISER.SCMAMBA.STAGE = 5
_C.MODEL.DENOISER.SCMAMBA.SHARE_PARAMS = True
_C.MODEL.DENOISER.SCMAMBA.WITH_DL = True
_C.MODEL.DENOISER.SCMAMBA.WITH_MU = True
_C.MODEL.DENOISER.SCMAMBA.WITH_NOISE_LEVEL = True
